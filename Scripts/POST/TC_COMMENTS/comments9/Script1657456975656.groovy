...
WS.verifyElementPropertyValue(respon1, 'name', 'voluptas')
WS.verifyElementPropertyValue(respon1, 'email', 'Littel@rene.us')
WS.verifyElementPropertyValue(respon1, 'body', 'nadipisci laborum distinctio aperiam et ab ut omnis\net occaecati aspernatur odit sit rem expedita\nquas enim ipsam minus')