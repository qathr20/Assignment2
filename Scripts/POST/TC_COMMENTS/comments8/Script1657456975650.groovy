...
WS.verifyElementPropertyValue(respon1, 'name', 't omnis dolorem')
WS.verifyElementPropertyValue(respon1, 'email', 'Mallor@marie.org')
WS.verifyElementPropertyValue(respon1, 'body', 'net nisi velit vero accusamus maiores\nvoluptates quia aliquid ullam eaque')